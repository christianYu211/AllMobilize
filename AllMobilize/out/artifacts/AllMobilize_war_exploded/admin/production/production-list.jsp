            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li> <a href="push-list.html">产品列表</a> </li>
                    </ul>
                </div>
            </div>
            <div id="page-wraper">
                        ...
                        <div class="span12">
                            <div class="widget red">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>产品列表</h4>
                                ...
                                <div class="widget-body">
                                    ...
                                    <table class="table table-striped table-bordered table-advance table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th><i class="icon-male"></i> 产品描述</th>
                                        ...
                                        <tbody>
<c:forEach var="production" items="${requestScope.page.items}" varStatus="i">
...
<tr>
    ...
    <c:choose>
        <c:when test="${fn:length(production.productdesc) > 10}">
            <td>${fn:substring(production.productdesc,0, 25)}...</td>
        </c:when>
    </c:choose>
                                            <td>${production.uploadtime}</td>
