            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li> <a href="admin/index.jsp">主页</a> <span class="divider">/</span> </li>
                        <li> <a href="push-list.html">管理员</a> </li>
                    </ul>
                </div>
            </div>
            <div id="page-wraper">
                        ...
                        <div class="span12">
                            <div class="widget red">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>管理员</h4>
                                ...
                                <div class="widget-body">
                                    ...
                                    <table class="table table-striped table-bordered table-advance table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th><i class="icon-male"></i> 密码</th>
                                            <th><i class="icon-time"></i> 昵称</th>

                                            <th><i class="icon-edit-sign"></i> 操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="admin" items="${requestScope.page.items}" varStatus="i">
                                        <tr>
