        ...
        <div class="container-fluid">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h5></h5>
                    <ul class="breadcrumb">
                        <li><a href="../common.html">主页</a> <span class="divider">/</span>
                        </li>
                        <li><a href="enterprise-list.html">解决方案</a> <span
                                class="divider">/</span></li>
                        <li><a href="enterprise-add.html">新增解决方案</a></li>
                    </ul>
                </div>
            </div>
            <div class="row-fluid">
                    ...
                    <div class="widget red">
                        ...
                        <div class="widget-body form">
                            <form class="cmxform form-horizontal" id="commentform"
                                ...
                                <input type="hidden" name="id" value="${requestScope.soltuion.id}">

                                <input type="hidden" name="op" value="saveSolution">
                                <div class="control-group ">
                                    <label for="cname" class="control-label">解决方案标题</label>
                                    <div class="controls">
                                        <input class="span3 " id="solutiontitle" name="solutiontitle"
                                               type="text" required />
                                    </div>
                                </div>
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input class="span6 " id="solutionpic" name="solutionpic"
                                               type="file" onchange="setImagePreview()" />
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    <a href="enterprise-list.html"><button
                                            class="btn btn-success" type="submit">确定</button></a> <a
                                        href="SolutionServlet">
