            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li> <a href="push-list.html">新闻</a> </li>
                    </ul>
                </div>
            </div>
            <div id="page-wraper">
                        ...
                        <div class="span12">
                            <div class="widget red">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>新闻</h4>
                                ...
                                <div class="widget-body">
                                    ...
                                    <table class="table table-striped table-bordered table-advance table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th><i class="icon-male"></i> 推送内容</th>
                                            <th><i class="icon-time"></i> 推送时间</th>

                                            <th><i class="icon-edit-sign"></i> 操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="news" items="${requestScope.page.items}" varStatus="i">
                                        ...
                                        <tr>
                                            ...
                                            <c:choose>
                                                <c:when test="${fn:length(news.newsdesc) > 10}">
                                                    <td>${fn:substring(news.newsdesc,0, 25)}...</td>
                                                </c:when>
                                            </c:choose>
