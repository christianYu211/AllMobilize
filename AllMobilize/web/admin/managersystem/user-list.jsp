            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li> <a href="push-list.html">用户</a> </li>
                    </ul>
                </div>
            </div>
            <div id="page-wraper">
                        ...
                        <div class="span12">
                            <div class="widget red">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>用户</h4>
                                ...
                                <div class="widget-body">
                                    ...
                                    <table class="table table-striped table-bordered table-advance table-hover">
                                        <thead>
                                            ...
                                            <th><i class="icon-male"></i> 昵称</th>
                                            <th><i class="icon-time"></i> 生日</th>

                                            <th><i class="icon-edit-sign"></i> 操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="user" items="${requestScope.page.items}" varStatus="i">
