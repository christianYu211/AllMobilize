            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li> <a href="push-list.html">客户案例</a> </li>
                    </ul>
                </div>
            </div>
            <div id="page-wraper">
                        ...
                        <div class="span12">
                            <div class="widget red">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>客户案例</h4>
                                ...
                                <div class="widget-body">
                                    ...
                                    <table class="table table-striped table-bordered table-advance table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th><i class="icon-bullhorn"></i> 案例名称</th>
                                            <th><i class="icon-male"></i> 案例概述</th>
                                        ...
                                        <tbody>
                                    <c:forEach var="customcase" items="${requestScope.page.items}" varStatus="i">
                                        <tr>
                                            <td><input type="checkbox" class="checkboxes" value="1" /></td>
                                            <td>${i.index+1}</td>
                                            <td>${customcase.customcasetitle}</td>
                                            <c:choose>
                                            <c:when test="${fn:length(customcase.customcasedesc) > 10}">
                                            <td>${fn:substring(customcase.customcasedesc,0, 25)}...</td>
                                            </c:when>
                                            </c:choose>
                                            <td>${customcase.createtime}</td>
